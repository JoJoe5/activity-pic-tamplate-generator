...
const MAX_UID = 1e6; const MILLISECONDS_MULTIPLIER = 1e3; const TRANSITION_END = 'transitionend'; const toType = (e) => (e == null ? `${e}` : {}.toString.call(e).match(/\s([a-z]+)/i)[1].toLowerCase()); const getUID = (e) => { do { e += Math.floor(1e6 * Math.random()); } while (document.getElementById(e));return e; }; const getSelector = (e) => { let t = e.getAttribute('data-bs-target'); if (!t || t === '#') { let i = e.getAttribute('href'); if (!i || !i.includes('#') && !i.startsWith('.')) return null; i.includes('#') && !i.startsWith('#') && (i = `#${i.split('#')[1]}`), t = i && i !== '#' ? i.trim() : null; } return t; }; const getSelectorFromElement = (e) => { const t = getSelector(e); return t && document.querySelector(t) ? t : null; }; const getElementFromSelector = (e) => { const t = getSelector(e); return t ? document.querySelector(t) : null; }; const getTransitionDurationFromElement = (e) => { if (!e) return 0; let{ transitionDuration: t, transitionDelay: i } = window.getComputedStyle(e); const n = Number.parseFloat(t); const s = Number.parseFloat(i); return n || s ? (t = t.split(',')[0], i = i.split(',')[0], 1e3 * (Number.parseFloat(t) + Number.parseFloat(i))) : 0; }; const triggerTransitionEnd = (e) => { e.dispatchEvent(new Event(TRANSITION_END)); }; const isElement = (e) => !(!e || typeof e !== 'object') && (void 0 !== e.jquery && (e = e[0]), void 0 !== e.nodeType); const getElement = (e) => (isElement(e) ? e.jquery ? e[0] : e : typeof e === 'string' && e.length > 0 ? document.querySelector(e) : null); const typeCheckConfig = (e, t, i) => { Object.keys(i).forEach(((n) => { const s = i[n]; const o = t[n]; const r = o && isElement(o) ? 'element' : (a = o) == null ? `${a}` : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase(); let a; if (!new RegExp(s).test(r)) throw new TypeError(`${e.toUpperCase()}: Option "${n}" provided type "${r}" but expected type "${s}".`); })); }; const isVisible = (e) => !(!isElement(e) || e.getClientRects().length === 0) && getComputedStyle(e).getPropertyValue('visibility') === 'visible'; const isDisabled = (e) => !e || e.nodeType !== Node.ELEMENT_NODE || !!e.classList.contains('disabled') || (void 0 !== e.disabled ? e.disabled : e.hasAttribute('disabled') && e.getAttribute('disabled') !== 'false'); const findShadowRoot = (e) => { if (!document.documentElement.attachShadow) return null; if (typeof e.getRootNode === 'function') { const t = e.getRootNode(); return t instanceof ShadowRoot ? t : null; } return e instanceof ShadowRoot ? e : e.parentNode ? findShadowRoot(e.parentNode) : null; }; const noop = () => {}; const reflow = (e) => { e.offsetHeight; }; const getjQuery = () => { const { jQuery: e } = window; return e && !document.body.hasAttribute('data-bs-no-jquery') ? e : null; }; const DOMContentLoadedCallbacks = []; const onDOMContentLoaded = (e) => { document.readyState === 'loading' ? (DOMContentLoadedCallbacks.length || document.addEventListener('DOMContentLoaded', (() => { DOMContentLoadedCallbacks.forEach(((e) => e())); })), DOMContentLoadedCallbacks.push(e)) : e(); }; const isRTL = () => document.documentElement.dir === 'rtl'; const defineJQueryPlugin = (e) => { let t; t = () => { const t = getjQuery(); if (t) { const i = e.NAME; const n = t.fn[i]; t.fn[i] = e.jQueryInterface, t.fn[i].Constructor = e, t.fn[i].noConflict = () => (t.fn[i] = n, e.jQueryInterface); } }, document.readyState === 'loading' ? (DOMContentLoadedCallbacks.length || document.addEventListener('DOMContentLoaded', (() => { DOMContentLoadedCallbacks.forEach(((e) => e())); })), DOMContentLoadedCallbacks.push(t)) : t(); }; const execute = (e) => { typeof e === 'function' && e(); }; const executeAfterTransition = (e, t, i = !0) => { if (!i) return void execute(e); const n = getTransitionDurationFromElement(t) + 5; let s = !1; const o = ({ target: i }) => { i === t && (s = !0, t.removeEventListener(TRANSITION_END, o), execute(e)); }; t.addEventListener(TRANSITION_END, o), setTimeout((() => { s || triggerTransitionEnd(t); }), n); }; const getNextActiveElement = (e, t, i, n) => { let s = e.indexOf(t); if (s === -1) return e[!i && n ? e.length - 1 : 0]; const o = e.length; return s += i ? 1 : -1, n && (s = (s + o) % o), e[Math.max(0, Math.min(s, o - 1))]; }; const namespaceRegex = /[^.]*(?=\..*)\.|.*/; const stripNameRegex = /\..*/; const stripUidRegex = /::\d+$/; const eventRegistry = {}; let uidEvent = 1; const customEvents = { mouseenter: 'mouseover', mouseleave: 'mouseout' }; const customEventsRegex = /^(mouseenter|mouseleave)/i; const nativeEvents = new Set(['click', 'dblclick', 'mouseup', 'mousedown', 'contextmenu', 'mousewheel', 'DOMMouseScroll', 'mouseover', 'mouseout', 'mousemove', 'selectstart', 'selectend', 'keydown', 'keypress', 'keyup', 'orientationchange', 'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerdown', 'pointermove', 'pointerup', 'pointerleave', 'pointercancel', 'gesturestart', 'gesturechange', 'gestureend', 'focus', 'blur', 'change', 'reset', 'select', 'submit', 'focusin', 'focusout', 'load', 'unload', 'beforeunload', 'resize', 'move', 'DOMContentLoaded', 'readystatechange', 'error', 'abort', 'scroll']); function getUidEvent(e, t) { return t && `${t}::${uidEvent++}` || e.uidEvent || uidEvent++; } function getEvent(e) { const t = getUidEvent(e); return e.uidEvent = t, eventRegistry[t] = eventRegistry[t] || {}, eventRegistry[t]; } function bootstrapHandler(e, t) { return function i(n) { return n.delegateTarget = e, i.oneOff && EventHandler.off(e, n.type, t), t.apply(e, [n]); }; } function bootstrapDelegationHandler(e, t, i) { return function n(s) { const o = e.querySelectorAll(t); for (let{ target: r } = s; r && r !== this; r = r.parentNode) for (let a = o.length; a--;) if (o[a] === r) return s.delegateTarget = r, n.oneOff && EventHandler.off(e, s.type, t, i), i.apply(r, [s]); return null; }; } function findHandler(e, t, i = null) { const n = Object.keys(e); for (let s = 0, o = n.length; s < o; s++) { const o = e[n[s]]; if (o.originalHandler === t && o.delegationSelector === i) return o; } return null; } function normalizeParams(e, t, i) { const n = typeof t === 'string'; const s = n ? i : t; let o = getTypeEvent(e); return nativeEvents.has(o) || (o = e), [n, s, o]; } function addHandler(e, t, i, n, s) { if (typeof t !== 'string' || !e) return; if (i || (i = n, n = null), customEventsRegex.test(t)) { const e = (e) => function (t) { if (!t.relatedTarget || t.relatedTarget !== t.delegateTarget && !t.delegateTarget.contains(t.relatedTarget)) return e.call(this, t); }; n ? n = e(n) : i = e(i); } const [o, r, a] = normalizeParams(t, i, n); const l = getEvent(e); const c = l[a] || (l[a] = {}); const E = findHandler(c, r, o ? i : null); if (E) return void (E.oneOff = E.oneOff && s); const _ = getUidEvent(r, t.replace(namespaceRegex, '')); const h = o ? bootstrapDelegationHandler(e, i, n) : bootstrapHandler(e, i); h.delegationSelector = o ? i : null, h.originalHandler = r, h.oneOff = s, h.uidEvent = _, c[_] = h, e.addEventListener(a, h, o); } function removeHandler(e, t, i, n, s) { const o = findHandler(t[i], n, s); o && (e.removeEventListener(i, o, Boolean(s)), delete t[i][o.uidEvent]); } function removeNamespacedHandlers(e, t, i, n) { const s = t[i] || {}; Object.keys(s).forEach(((o) => { if (o.includes(n)) { const n = s[o]; removeHandler(e, t, i, n.originalHandler, n.delegationSelector); } })); } function getTypeEvent(e) { return e = e.replace(stripNameRegex, ''), customEvents[e] || e; } const EventHandler = {
...
}enableDismissTrigger(Alert, 'close'), defineJQueryPlugin(Alert); const NAME$c = 'button'; const DATA_KEY$b = 'bs.button'; const EVENT_KEY$b = '.bs.button'; const DATA_API_KEY$7 = '.data-api'; const CLASS_NAME_ACTIVE$3 = 'active'; const SELECTOR_DATA_TOGGLE$5 = '[data-bs-toggle="button"]'; const EVENT_CLICK_DATA_API$6 = 'click.bs.button.data-api'; class Button extends BaseComponent {
  ...
  find: (e, t = document.documentElement) => [].concat(...Element.prototype.querySelectorAll.call(t, e)), findOne: (e, t = document.documentElement) => Element.prototype.querySelector.call(t, e), children: (e, t) => [].concat(...e.children).filter(((e) => e.matches(t))), parents(e, t) { const i = []; let n = e.parentNode; for (;n && n.nodeType === Node.ELEMENT_NODE && n.nodeType !== 3;)n.matches(t) && i.push(n), n = n.parentNode; return i; }, prev(e, t) { let i = e.previousElementSibling; for (;i;) { if (i.matches(t)) return [i]; i = i.previousElementSibling; } return []; }, next(e, t) { let i = e.nextElementSibling; for (;i;) { if (i.matches(t)) return [i]; i = i.nextElementSibling; } return []; }, focusableChildren(e) { const t = ['a', 'button', 'input', 'textarea', 'select', 'details', '[tabindex]', '[contenteditable="true"]'].map(((e) => `${e}:not([tabindex^="-"])`)).join(', '); return this.find(t, e).filter(((e) => !isDisabled(e) && isVisible(e))); },
}; const NAME$b = 'carousel'; const DATA_KEY$a = 'bs.carousel'; const EVENT_KEY$a = '.bs.carousel'; const DATA_API_KEY$6 = '.data-api'; const ARROW_LEFT_KEY = 'ArrowLeft'; const ARROW_RIGHT_KEY = 'ArrowRight'; const TOUCHEVENT_COMPAT_WAIT = 500; const SWIPE_THRESHOLD = 40; const Default$a = {
  ...
  _getConfig(e) { return e = { ...Default$a, ...Manipulator.getDataAttributes(this._element), ...typeof e === 'object' ? e : {} }, typeCheckConfig(NAME$b, e, DefaultType$a), e; }
  ...
  _triggerSlideEvent(e, t) {
    const i = this._getItemIndex(e); const n = this._getItemIndex(SelectorEngine.findOne(SELECTOR_ACTIVE_ITEM, this._element)); return EventHandler.trigger(this._element, EVENT_SLIDE, {
      relatedTarget: e, direction: t, from: n, to: i,
    });
  }

  _setActiveIndicatorElement(e) { if (this._indicatorsElement) { const t = SelectorEngine.findOne('.active', this._indicatorsElement); t.classList.remove('active'), t.removeAttribute('aria-current'); const i = SelectorEngine.find('[data-bs-target]', this._indicatorsElement); for (let t = 0; t < i.length; t++) if (Number.parseInt(i[t].getAttribute('data-bs-slide-to'), 10) === this._getItemIndex(e)) { i[t].classList.add('active'), i[t].setAttribute('aria-current', 'true'); break; } } }
  ...
  static carouselInterface(e, t) { const i = Carousel.getOrCreateInstance(e, t); let{ _config: n } = i; typeof t === 'object' && (n = { ...n, ...t }); const s = typeof t === 'string' ? t : n.slide; if (typeof t === 'number')i.to(t); else if (typeof s === 'string') { if (void 0 === i[s]) throw new TypeError(`No method named "${s}"`); i[s](); } else n.interval && n.ride && (i.pause(), i.cycle()); }

  static jQueryInterface(e) { return this.each((function () { Carousel.carouselInterface(this, e); })); }

  static dataApiClickHandler(e) { const t = getElementFromSelector(this); if (!t || !t.classList.contains('carousel')) return; const i = { ...Manipulator.getDataAttributes(t), ...Manipulator.getDataAttributes(this) }; const n = this.getAttribute('data-bs-slide-to'); n && (i.interval = !1), Carousel.carouselInterface(t, i), n && Carousel.getInstance(t).to(n), e.preventDefault(); }
  ...
  constructor(e, t) { super(e), this._isTransitioning = !1, this._config = this._getConfig(t), this._triggerArray = []; const i = SelectorEngine.find(SELECTOR_DATA_TOGGLE$4); for (let e = 0, t = i.length; e < t; e++) { const t = i[e]; const n = getSelectorFromElement(t); const s = SelectorEngine.find(n).filter(((e) => e === this._element)); n !== null && s.length && (this._selector = n, this._triggerArray.push(t)); } this._initializeChildren(), this._config.parent || this._addAriaAndCollapsedClass(this._triggerArray, this._isShown()), this._config.toggle && this.toggle(); }
  ...
  _initializeChildren() { if (!this._config.parent) return; const e = SelectorEngine.find(CLASS_NAME_DEEPER_CHILDREN, this._config.parent); SelectorEngine.find(SELECTOR_DATA_TOGGLE$4, this._config.parent).filter(((t) => !e.includes(t))).forEach(((e) => { const t = getElementFromSelector(e); t && this._addAriaAndCollapsedClass([e], this._isShown(t)); })); }
  ...
  hide() { if (isDisabled(this._element) || !this._isShown(this._menu)) return; const e = { relatedTarget: this._element }; this._completeHide(e); }
  ...
  _getConfig(e) { if (e = { ...this.constructor.Default, ...Manipulator.getDataAttributes(this._element), ...e }, typeCheckConfig(NAME$9, e, this.constructor.DefaultType), typeof e.reference === 'object' && !isElement(e.reference) && typeof e.reference.getBoundingClientRect !== 'function') throw new TypeError(`${NAME$9.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`); return e; }

  _createPopper(e) { if (void 0 === Popper) throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)"); let t = this._element; this._config.reference === 'parent' ? t = e : isElement(this._config.reference) ? t = getElement(this._config.reference) : typeof this._config.reference === 'object' && (t = this._config.reference); const i = this._getPopperConfig(); const n = i.modifiers.find(((e) => e.name === 'applyStyles' && !1 === e.enabled)); this._popper = Popper.createPopper(t, this._menu, i), n && Manipulator.setDataAttribute(this._menu, 'popper', 'static'); }
  ...
  _selectMenuItem({ key: e, target: t }) { const i = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(isVisible); i.length && getNextActiveElement(i, t, e === 'ArrowDown', !i.includes(t)).focus(); }
  ...
  static clearMenus(e) { if (e && (e.button === 2 || e.type === 'keyup' && e.key !== 'Tab')) return; const t = SelectorEngine.find(SELECTOR_DATA_TOGGLE$3); for (let i = 0, n = t.length; i < n; i++) { const n = Dropdown.getInstance(t[i]); if (!n || !1 === n._config.autoClose) continue; if (!n._isShown()) continue; const s = { relatedTarget: n._element }; if (e) { const t = e.composedPath(); const i = t.includes(n._menu); if (t.includes(n._element) || n._config.autoClose === 'inside' && !i || n._config.autoClose === 'outside' && i) continue; if (n._menu.contains(e.target) && (e.type === 'keyup' && e.key === 'Tab' || /input|select|option|textarea|form/i.test(e.target.tagName))) continue; e.type === 'click' && (s.clickEvent = e); }n._completeHide(s); } }

  static getParentFromElement(e) { return getElementFromSelector(e) || e.parentNode; }

  static dataApiKeydownHandler(e) { if (/input|textarea/i.test(e.target.tagName) ? e.key === 'Space' || e.key !== 'Escape' && (e.key !== 'ArrowDown' && e.key !== 'ArrowUp' || e.target.closest(SELECTOR_MENU)) : !REGEXP_KEYDOWN.test(e.key)) return; const t = this.classList.contains('show'); if (!t && e.key === 'Escape') return; if (e.preventDefault(), e.stopPropagation(), isDisabled(this)) return; const i = this.matches(SELECTOR_DATA_TOGGLE$3) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$3)[0]; const n = Dropdown.getOrCreateInstance(i); if (e.key !== 'Escape') return e.key === 'ArrowUp' || e.key === 'ArrowDown' ? (t || n.show(), void n._selectMenuItem(e)) : void (t && e.key !== 'Space' || Dropdown.clearMenus()); n.hide(); }
  ...
  _setElementAttributes(e, t, i) { const n = this.getWidth(); this._applyManipulationCallback(e, ((e) => { if (e !== this._element && window.innerWidth > e.clientWidth + n) return; this._saveInitialAttribute(e, t); const s = window.getComputedStyle(e)[t]; e.style[t] = `${i(Number.parseFloat(s))}px`; })); }
  ...
  _saveInitialAttribute(e, t) { const i = e.style[t]; i && Manipulator.setDataAttribute(e, t, i); }

  _resetElementAttributes(e, t) { this._applyManipulationCallback(e, ((e) => { const i = Manipulator.getDataAttribute(e, t); void 0 === i ? e.style.removeProperty(t) : (Manipulator.removeDataAttribute(e, t), e.style[t] = i); })); }
...
}; const NAME$8 = 'backdrop'; const CLASS_NAME_FADE$4 = 'fade'; const CLASS_NAME_SHOW$5 = 'show'; const EVENT_MOUSEDOWN = 'mousedown.bs.backdrop'; class Backdrop {
  ...
  _getConfig(e) { return (e = { ...Default$7, ...typeof e === 'object' ? e : {} }).rootElement = getElement(e.rootElement), typeCheckConfig(NAME$8, e, DefaultType$7), e; }
  ...
  activate() { const { trapElement: e, autofocus: t } = this._config; this._isActive || (t && e.focus(), EventHandler.off(document, EVENT_KEY$7), EventHandler.on(document, EVENT_FOCUSIN$1, ((e) => this._handleFocusin(e))), EventHandler.on(document, EVENT_KEYDOWN_TAB, ((e) => this._handleKeydown(e))), this._isActive = !0); }

  deactivate() { this._isActive && (this._isActive = !1, EventHandler.off(document, EVENT_KEY$7)); }

  _handleFocusin(e) { const { target: t } = e; const { trapElement: i } = this._config; if (t === document || t === i || i.contains(t)) return; const n = SelectorEngine.focusableChildren(i); n.length === 0 ? i.focus() : this._lastTabNavDirection === 'backward' ? n[n.length - 1].focus() : n[0].focus(); }

  _handleKeydown(e) { e.key === 'Tab' && (this._lastTabNavDirection = e.shiftKey ? 'backward' : 'forward'); }

  _getConfig(e) { return e = { ...Default$6, ...typeof e === 'object' ? e : {} }, typeCheckConfig(NAME$7, e, DefaultType$6), e; }
  ...
  dispose() { [window, this._dialog].forEach(((e) => EventHandler.off(e, '.bs.modal'))), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose(); }
  ...
  _showBackdrop(e) { EventHandler.on(this._element, EVENT_CLICK_DISMISS, ((e) => { this._ignoreBackdropClick ? this._ignoreBackdropClick = !1 : e.target === e.currentTarget && (!0 === this._config.backdrop ? this.hide() : this._config.backdrop === 'static' && this._triggerBackdropTransition()); })), this._backdrop.show(e); }
  ...
  _adjustDialog() { const e = this._element.scrollHeight > document.documentElement.clientHeight; const t = this._scrollBar.getWidth(); const i = t > 0; (!i && e && !isRTL() || i && !e && isRTL()) && (this._element.style.paddingLeft = `${t}px`), (i && !e && !isRTL() || !i && e && isRTL()) && (this._element.style.paddingRight = `${t}px`); }

  _resetAdjustments() { this._element.style.paddingLeft = '', this._element.style.paddingRight = ''; }

  static jQueryInterface(e, t) { return this.each((function () { const i = Modal.getOrCreateInstance(this, e); if (typeof e === 'string') { if (void 0 === i[e]) throw new TypeError(`No method named "${e}"`); i[e](t); } })); }
}EventHandler.on(document, EVENT_CLICK_DATA_API$2, SELECTOR_DATA_TOGGLE$2, (function (e) { const t = getElementFromSelector(this); ['A', 'AREA'].includes(this.tagName) && e.preventDefault(), EventHandler.one(t, EVENT_SHOW$3, ((e) => { e.defaultPrevented || EventHandler.one(t, EVENT_HIDDEN$3, (() => { isVisible(this) && this.focus(); })); })); const i = SelectorEngine.findOne('.modal.show'); i && Modal.getInstance(i).hide(), Modal.getOrCreateInstance(t).toggle(this); })), enableDismissTrigger(Modal), defineJQueryPlugin(Modal); const NAME$5 = 'offcanvas'; const DATA_KEY$5 = 'bs.offcanvas'; const EVENT_KEY$5 = '.bs.offcanvas'; const DATA_API_KEY$2 = '.data-api'; const EVENT_LOAD_DATA_API$1 = 'load.bs.offcanvas.data-api'; const ESCAPE_KEY = 'Escape'; const Default$4 = { backdrop: !0, keyboard: !0, scroll: !1 }; const DefaultType$4 = { backdrop: 'boolean', keyboard: 'boolean', scroll: 'boolean' }; const CLASS_NAME_SHOW$3 = 'show'; const CLASS_NAME_BACKDROP = 'offcanvas-backdrop'; const OPEN_SELECTOR = '.offcanvas.show'; const EVENT_SHOW$2 = 'show.bs.offcanvas'; const EVENT_SHOWN$2 = 'shown.bs.offcanvas'; const EVENT_HIDE$2 = 'hide.bs.offcanvas'; const EVENT_HIDDEN$2 = 'hidden.bs.offcanvas'; const EVENT_CLICK_DATA_API$1 = 'click.bs.offcanvas.data-api'; const EVENT_KEYDOWN_DISMISS = 'keydown.dismiss.bs.offcanvas'; const SELECTOR_DATA_TOGGLE$1 = '[data-bs-toggle="offcanvas"]'; class Offcanvas extends BaseComponent {
  ...
  _initializeBackDrop() {
    return new Backdrop({
      className: CLASS_NAME_BACKDROP, isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide(),
    });
  }

  _initializeFocusTrap() { return new FocusTrap({ trapElement: this._element }); }

  _addEventListeners() { EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS, ((e) => { this._config.keyboard && e.key === 'Escape' && this.hide(); })); }
...
}; function sanitizeHtml(e, t, i) { if (!e.length) return e; if (i && typeof i === 'function') return i(e); const n = (new window.DOMParser()).parseFromString(e, 'text/html'); const s = [].concat(...n.body.querySelectorAll('*')); for (let e = 0, i = s.length; e < i; e++) { const i = s[e]; const n = i.nodeName.toLowerCase(); if (!Object.keys(t).includes(n)) { i.remove(); continue; } const o = [].concat(...i.attributes); const r = [].concat(t['*'] || [], t[n] || []); o.forEach(((e) => { allowedAttribute(e, r) || i.removeAttribute(e.nodeName); })); } return n.body.innerHTML; } const NAME$4 = 'tooltip'; const DATA_KEY$4 = 'bs.tooltip'; const EVENT_KEY$4 = '.bs.tooltip'; const CLASS_PREFIX$1 = 'bs-tooltip'; const DISALLOWED_ATTRIBUTES = new Set(['sanitize', 'allowList', 'sanitizeFn']); const DefaultType$3 = {
  ...
  _setListeners() { this._config.trigger.split(' ').forEach(((e) => { if (e === 'click')EventHandler.on(this._element, this.constructor.Event.CLICK, this._config.selector, ((e) => this.toggle(e))); else if (e !== 'manual') { const t = e === 'hover' ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN; const i = e === 'hover' ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT; EventHandler.on(this._element, t, this._config.selector, ((e) => this._enter(e))), EventHandler.on(this._element, i, this._config.selector, ((e) => this._leave(e))); } })), this._hideModalHandler = () => { this._element && this.hide(); }, EventHandler.on(this._element.closest('.modal'), 'hide.bs.modal', this._hideModalHandler), this._config.selector ? this._config = { ...this._config, trigger: 'manual', selector: '' } : this._fixTitle(); }
  ...
  _cleanTipClass() { const e = this.getTipElement(); const t = new RegExp(`(^|\\s)${this._getBasicClassPrefix()}\\S+`, 'g'); const i = e.getAttribute('class').match(t); i !== null && i.length > 0 && i.map(((e) => e.trim())).forEach(((t) => e.classList.remove(t))); }
...
}defineJQueryPlugin(Tooltip); const NAME$3 = 'popover'; const DATA_KEY$3 = 'bs.popover'; const EVENT_KEY$3 = '.bs.popover'; const CLASS_PREFIX = 'bs-popover'; const Default$2 = {
...
}; const SELECTOR_TITLE = '.popover-header'; const SELECTOR_CONTENT = '.popover-body'; class Popover extends Tooltip {
...
}defineJQueryPlugin(Popover); const NAME$2 = 'scrollspy'; const DATA_KEY$2 = 'bs.scrollspy'; const EVENT_KEY$2 = '.bs.scrollspy'; const DATA_API_KEY$1 = '.data-api'; const Default$1 = { offset: 10, method: 'auto', target: '' }; const DefaultType$1 = { offset: 'number', method: 'string', target: '(string|element)' }; const EVENT_ACTIVATE = 'activate.bs.scrollspy'; const EVENT_SCROLL = 'scroll.bs.scrollspy'; const EVENT_LOAD_DATA_API = 'load.bs.scrollspy.data-api'; const CLASS_NAME_DROPDOWN_ITEM = 'dropdown-item'; const CLASS_NAME_ACTIVE$1 = 'active'; const SELECTOR_DATA_SPY = '[data-bs-spy="scroll"]'; const SELECTOR_NAV_LIST_GROUP$1 = '.nav, .list-group'; const SELECTOR_NAV_LINKS = '.nav-link'; const SELECTOR_NAV_ITEMS = '.nav-item'; const SELECTOR_LIST_ITEMS = '.list-group-item'; const SELECTOR_LINK_ITEMS = '.nav-link, .list-group-item, .dropdown-item'; const SELECTOR_DROPDOWN$1 = '.dropdown'; const SELECTOR_DROPDOWN_TOGGLE$1 = '.dropdown-toggle'; const METHOD_OFFSET = 'offset'; const METHOD_POSITION = 'position'; class ScrollSpy extends BaseComponent {
  constructor(e, t) { super(e), this._scrollElement = this._element.tagName === 'BODY' ? window : this._element, this._config = this._getConfig(t), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, EventHandler.on(this._scrollElement, EVENT_SCROLL, (() => this._process())), this.refresh(), this._process(); }
  ...
  refresh() {
    const e = this._scrollElement === this._scrollElement.window ? 'offset' : 'position'; const t = this._config.method === 'auto' ? e : this._config.method; const
  ...
  _getConfig(e) { return (e = { ...Default$1, ...Manipulator.getDataAttributes(this._element), ...typeof e === 'object' && e ? e : {} }).target = getElement(e.target) || document.documentElement, typeCheckConfig(NAME$2, e, DefaultType$1), e; }
  ...
  _onInteraction(e, t) { switch (e.type) { case 'mouseover': case 'mouseout': this._hasMouseInteraction = t; break; case 'focusin': case 'focusout': this._hasKeyboardInteraction = t; } if (t) return void this._clearTimeout(); const i = e.relatedTarget; this._element === i || this._element.contains(i) || this._maybeScheduleHide(); }
